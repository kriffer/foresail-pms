(function ($) {
	...
	AvailabilityCalendar.prototype = {
		...
		__createTable: function () {
			...
			var now = new Date();
			var num_days = new Date(now.getFullYear(), now.getMonth() + 1, 0).getDate();

			// Weekday headers   
			var $tr = $('<tr></tr>').appendTo($table);
			$('<th></th>').html("Rooms").appendTo($tr); //added room column header
			for (i = 1; i <= 31; i++) {
